...
do
    if (#args > 0 and typeof(args[1]) == 'table') then
        ...
        if (typeof(theme) == 'string') then
            if (theme == 'cherry') then          -- red
                theme = {
                    Primary = Color3RGB(249, 22, 52);
                    Secondary = Color3RGB(247, 22, 149);
                    
                    Window1 = Color3RGB(11, 11, 11);
                    Window2 = Color3RGB(5, 5, 5);
                    Window3 = Color3RGB(8, 8, 8);
                    
                    Button1 = Color3RGB(12, 12, 12);
                    Button2 = Color3RGB(15, 15, 15);
                    Button3 = Color3RGB(21, 21, 21);
                    Button4 = Color3RGB(24, 24, 24);
                    
                    Stroke = Color3RGB(30, 30, 30);
                    StrokeHover = Color3RGB(83, 23, 31);
                    
                    Inset1 = Color3RGB(3, 3, 3);
                    Inset2 = Color3RGB(1, 1, 1);
                    Inset3 = Color3RGB(2, 2, 2);
                    
                    TextPrimary = Color3RGB(255, 255, 255);
                    TextStroke = Color3RGB(0, 0, 0);
                    TextDim = Color3RGB(164, 164, 164);
                    
                    ControlGradient1 = Color3RGB(255, 255, 255);
                    ControlGradient2 = Color3RGB(200, 200, 200);
                }
            elseif (theme == 'orange') then      -- orange
                theme = {
                    Primary = Color3RGB(244, 148, 22);
                    Secondary = Color3RGB(247, 37, 22);
                    
                    Window1 = Color3RGB(20, 20, 22);
                    Window2 = Color3RGB(10, 10, 12);
                    Window3 = Color3RGB(15, 15, 17);
                    
                    Button1 = Color3RGB(18, 18, 20);
                    Button2 = Color3RGB(20, 20, 22);
                    Button3 = Color3RGB(28, 28, 30);
                    Button4 = Color3RGB(30, 30, 32);
                    
                    Stroke = Color3RGB(60, 60, 60);
                    StrokeHover = Color3RGB(110, 110, 110);
                    
                    Inset1 = Color3RGB(10, 10, 12);
                    Inset2 = Color3RGB(0, 0, 2);
                    Inset3 = Color3RGB(5, 5, 7);
                    
                    TextPrimary = Color3RGB(255, 255, 255);
                    TextStroke = Color3RGB(0, 0, 0);
                    TextDim = Color3RGB(192, 192, 192);
                    
                    ControlGradient1 = Color3RGB(255, 255, 255);
                    ControlGradient2 = Color3RGB(192, 192, 192);
                }
            elseif (theme == 'lemon') then       -- yellow
                theme = {
                    Primary = Color3RGB(220, 255, 66);
                    Secondary = Color3RGB(232, 173, 25);
                    
                    Window1 = Color3RGB(30, 30, 30);
                    Window2 = Color3RGB(20, 20, 20);
                    Window3 = Color3RGB(25, 25, 25);
                    
                    Button1 = Color3RGB(35, 35, 35);
                    Button2 = Color3RGB(40, 40, 40);
                    Button3 = Color3RGB(50, 50, 50);
                    Button4 = Color3RGB(55, 55, 55);
                    
                    Stroke = Color3RGB(55, 55, 55);
                    StrokeHover = Color3RGB(80, 80, 80);
                    
                    Inset1 = Color3RGB(18, 18, 18);
                    Inset2 = Color3RGB(8, 8, 8);
                    Inset3 = Color3RGB(13, 13, 13);
            ...
            elseif (theme == 'lime') then        -- green
                theme = {
                    Primary = Color3RGB(33, 255, 120);
                    Secondary = Color3RGB(120, 255, 33);
                    
                    Window1 = Color3RGB(30, 30, 32);
                    Window2 = Color3RGB(24, 24, 26);
                    Window3 = Color3RGB(28, 28, 30);
                    
                    Button1 = Color3RGB(36, 36, 38);
                    Button2 = Color3RGB(40, 40, 42);
                    Button3 = Color3RGB(46, 46, 48);
                    Button4 = Color3RGB(50, 50, 52);
                    
                    Stroke = Color3RGB(60, 60, 60);
                    StrokeHover = Color3RGB(110, 110, 110);
                    
                    Inset1 = Color3RGB(20, 20, 22);
                    Inset2 = Color3RGB(14, 14, 16);
                    Inset3 = Color3RGB(18, 18, 20);
            ...
            elseif (theme == 'raspberry') then   -- cyan
                theme = {
                    Primary = Color3RGB(0, 190, 255);
                    Secondary = Color3RGB(0, 255, 190);
                    
                    Window1 = Color3RGB(25, 25, 27);
                    Window2 = Color3RGB(19, 19, 21);
                    Window3 = Color3RGB(23, 23, 25);
                    
                    Button1 = Color3RGB(24, 24, 26);
                    Button2 = Color3RGB(28, 28, 30);
                    Button3 = Color3RGB(34, 40, 42);
                    Button4 = Color3RGB(38, 44, 46);
            ...
            elseif (theme == 'blueberry') then   -- blue
                theme = {
                    Primary = Color3RGB(91, 77, 249);
                    Secondary = Color3RGB(130, 76, 247);
                    
                    Window1 = Color3RGB(20, 20, 23);
                    Window2 = Color3RGB(12, 12, 15);
                    Window3 = Color3RGB(15, 15, 18);
                    
                    Button1 = Color3RGB(18, 18, 21);
                    Button2 = Color3RGB(21, 21, 24);
                    Button3 = Color3RGB(38, 38, 41);
                    Button4 = Color3RGB(41, 41, 44);
                    
                    Stroke = Color3RGB(50, 50, 53);
                    StrokeHover = Color3RGB(60, 60, 63);
                    
                    Inset1 = Color3RGB(15, 15, 18);
                    Inset2 = Color3RGB(7, 7, 10);
                    Inset3 = Color3RGB(13, 13, 16);
                    
                    TextPrimary = Color3RGB(255, 255, 255);
                    TextStroke = Color3RGB(0, 0, 0);
                    TextDim = Color3RGB(168, 168, 168);
            ...
            elseif (theme == 'grape') then       -- purple
                ...
                theme = {
                    Primary = Color3RGB(134, 53, 255);
                    Secondary = Color3RGB(211, 53, 255);
                    
                    Window1 = Color3RGB(20, 20, 20);
                    Window2 = Color3RGB(10, 10, 10);
                    Window3 = Color3RGB(15, 15, 15);
                    
                    Button1 = Color3RGB(15, 15, 15);
                    Button2 = Color3RGB(20, 20, 20);
                    Button3 = Color3RGB(35, 35, 35);
                    Button4 = Color3RGB(40, 40, 40);
                    
                    Stroke = Color3RGB(34, 34, 34);
                    StrokeHover = Color3RGB(89, 49, 150);
                    
                    Inset1 = Color3RGB(5, 5, 5);
                    Inset2 = Color3RGB(0, 0, 0);
                    Inset3 = Color3RGB(3, 3, 3);
                    
                    TextPrimary = Color3RGB(255, 255, 255);
                    TextStroke = Color3RGB(0, 0, 0);
                    TextDim = Color3RGB(74, 42, 122);
    ...
    if (typeof(theme) ~= 'table') then
        theme = {
            Primary = Color3RGB(38, 233, 195); -- primary accent
            Secondary = Color3RGB(233, 38, 115); -- secondary accent
            
            Window1 = Color3RGB(30, 30, 35); -- window headers (the tool bar w/ title and min/max buttons)
            Window2 = Color3RGB(20, 20, 25); -- window background
            Window3 = Color3RGB(25, 25, 30); -- sidebar, section header, tooltip header
            
            Button1 = Color3RGB(35, 35, 40); -- idle disabled button
            Button2 = Color3RGB(45, 45, 50); -- disabled button focused
            Button3 = Color3RGB(65, 65, 70); -- idle enabled button
            Button4 = Color3RGB(75, 75, 80); -- enabled button focused
            
            Stroke = Color3RGB(50, 50, 55); -- stroke for everything
            StrokeHover = Color3RGB(70, 70, 75); -- stroke for everything
            
            Inset1 = Color3RGB(20, 20, 25); -- inner stroke of Window1
            Inset2 = Color3RGB(10, 10, 15); -- inner stroke of Window2
            Inset3 = Color3RGB(15, 15, 20); -- inner stroke of Window3
            
            TextPrimary = Color3RGB(255, 255, 255); -- primary text color
            TextStroke = Color3RGB(0, 0, 0); -- text stroke
            TextDim = Color3RGB(164, 164, 164); -- dim text color
            
            ControlGradient1 = Color3RGB(255, 255, 255); -- top color for extra gradient effects
            ControlGradient2 = Color3RGB(192, 192, 192); -- bottom color for extra gradient effects
        }
    end
end
    ...
    do
        ...
        do 
            ...
            local shadow = Instance.new('ImageLabel') do 
                ...
                sethiddenproperty(shadow, "Image", 'rbxassetid://7331400934')
                shadow.ImageColor3 = Color3RGB(0, 0, 5)
                shadow.Name = '#shadow'
            ...
            local trim = Instance.new('Frame') do 
                trim.BackgroundColor3 = Color3RGB(255, 255, 255)
...
do 
        ...
        local window = {} do 
            ...
            local instances = {} do 
                ...
                local trimLine = Instance.new('Frame') do 
                    trimLine.BackgroundColor3 = Color3RGB(255, 255, 255)
                ...
                local titleBar = Instance.new('Frame') do 
                    ...
                    local buttonClose = Instance.new('TextButton') do 
                        ...
                        local icon = Instance.new('ImageLabel') do 
                            ...
                            sethiddenproperty(icon, "Image", 'rbxassetid://9801460300')
                            icon.ImageColor3 = Color3RGB(255, 255, 255)
                            icon.Name = '#icon'
                    ...
                    local buttonMin = Instance.new('TextButton') do 
                        ...
                        local icon = Instance.new('ImageLabel') do 
                            ...
                            sethiddenproperty(icon, "Image", 'rbxassetid://9801458532')
                            icon.ImageColor3 = Color3RGB(255, 255, 255)
                            icon.Name = '#icon'
                            icon.Position = UDim2.fromOffset(0, 0)
                            icon.Size = UDim2.fromScale(1, 1)
                    ...
                    local icon = Instance.new('ImageLabel') do 
                        ...
                        sethiddenproperty(icon, "Image", 'rbxassetid://10152328589')
                        icon.ImageColor3 = Color3RGB(255, 255, 255)
                ...
                local pageRegion = Instance.new('Frame') do 
                    ...
                    local shadowLeft = Instance.new('Frame') do 
                        shadowLeft.BackgroundColor3 = Color3RGB(0, 0, 0)
                    ...
                    local shadowTop = Instance.new('Frame') do 
                        shadowTop.BackgroundColor3 = Color3RGB(0, 0, 0)
                ...
                local sideBar = Instance.new('Frame') do 
                    ...
                    local menu = Instance.new('ScrollingFrame') do 
                        ...
                        menu.ScrollBarImageColor3 = Color3RGB(255, 255, 255)
                ...
                local resizeHandle = Instance.new('ImageLabel') do 
                    ...
                    sethiddenproperty(resizeHandle, "Image", 'rbxassetid://9995727737')
            ...
            window.setIcon = function(self, newIcon) 
                ...
                sethiddenproperty(self.instances.mainFrame['#title-bar']['#icon'], "Image", newIcon)
                return self
            end
            ...
            window.minimize = function(self) 
                ...
                if (newState) then
                    ...
                    sethiddenproperty(bminIcon, "Image", 'rbxassetid://9642646619')
                    ...
                    sethiddenproperty(bminIcon, "Image", 'rbxassetid://9642680675')
                    tween(bminIcon, {
                        Rotation = 0,
                        ImageColor3 = Color3RGB(255, 255, 255)
                    }, 0.3, 1)
    ...
    do 
        ...
        local pickerWindow = {} do 
            ...
            pickerWindow.color = Color3HSV(0, 0, 1)
            ...
            pickerWindow.toggleChroma = function(self) 
                ...
                if (newState) then
                    ...
                    sethiddenproperty(chromaButton['#icon'], "Image", 'rbxassetid://9840988620')
                    ...
                    sethiddenproperty(chromaButton['#icon'], "Image", 'rbxassetid://9841673199')
            ...
            pickerWindow.displayRGB = function(self) 
                ...
                self.instances.valSlider['#slider-container'].BackgroundColor3 = Color3HSV(hue, sat, 1)
            ...
            pickerWindow.displayHSV = function(self, moveCursor) 
                ...
                self.color = Color3HSV(hue, sat, val)
                ...
                instances.valSlider['#slider-container'].BackgroundColor3 = Color3HSV(hue, sat, 1)
            ...
            local instances = {} do 
                ...
                local titleBar = Instance.new('Frame') do 
                    ...
                    local icon = Instance.new('ImageLabel') do 
                        ...
                        sethiddenproperty(icon, "Image", 'rbxassetid://9658988382')
                        icon.ImageColor3 = Color3RGB(255, 255, 255)
                        icon.ImageTransparency = 0
                        icon.Name = '#icon'
                ...
                local region = Instance.new('Frame') do 
                    ...
                    local pickerRegion = Instance.new('Frame') do 
                        ...
                        local picker = Instance.new('ImageLabel') do 
                            ...
                            sethiddenproperty(picker, "Image", 'rbxassetid://9801454501')
                            picker.Name = '#picker'
                            ...
                            local cursorInner = Instance.new('Frame') do 
                                ...
                                local stroke = Instance.new('UIStroke') do 
                                    stroke.ApplyStrokeMode = 'Border'
                                    stroke.Color = Color3RGB(255, 255, 255)
                                    stroke.LineJoinMode = 'Round'
                                    stroke.Name = '#stroke'
                                    stroke.Thickness = 1
                        ...
                        local valueSlider = Instance.new('Frame') do 
                            ...
                            local sliderContainer = Instance.new('Frame') do 
                                sliderContainer.BackgroundColor3 = Color3RGB(255, 255, 255)
                                ...
                                local valueGradient = Instance.new('Frame') do 
                                    valueGradient.BackgroundColor3 = Color3RGB(255, 255, 255)
                        ...
                        local speedSlider = Instance.new('Frame') do 
                            ...
                            local sliderContainer = Instance.new('Frame') do 
                                ...
                                local speedGradient = Instance.new('Frame') do 
                                    speedGradient.BackgroundColor3 = Color3RGB(255, 255, 255)
                        ...
                        local chroma = Instance.new('TextButton') do 
                            ...
                            local icon = Instance.new('ImageLabel') do 
                                ...
                                sethiddenproperty(icon, "Image", 'rbxassetid://9841673199')
                                icon.ImageColor3 = Color3RGB(255, 255, 255)
                                icon.Name = '#icon'
                                icon.Position = UDim2.fromOffset(0, 0)
                                icon.Rotation = 0
            ...
            pickerWindow.new = function(self, resize) 
                ...
                do 
                    ...
                    container.MouseLeave:Connect(function() 
                        ...
                        tween(cursor['#stroke'], {Color = Color3RGB(255, 255, 255)}, 0.2, 1)
                    end)
                end
                ...
                local titleBar = Instance.new('Frame') do 
                    ...
                    local minimize = Instance.new('TextButton') do 
                        ...
                        local icon = Instance.new('ImageLabel') do 
                            ...
                            sethiddenproperty(icon, "Image", 'rbxassetid://9801471573')
                            icon.ImageColor3 = Color3RGB(255, 255, 255)
                            icon.Name = '#icon'
                            icon.Position = UDim2.fromOffset(0, 0)
                            icon.Size = UDim2.fromScale(1, 1)
        ...
        local toggle = {} do 
                    ...
                    local backToggle = Instance.new('TextButton') do 
                        ...
                        local toggle = Instance.new('Frame') do 
                            ...
                            local icon = Instance.new('ImageLabel') do 
                                ...
                                sethiddenproperty(icon, "Image", 'rbxassetid://9801456486')
            ...
            toggle.toggle = function(self) 
                ...
                if (newState) then
                    ...
                    sethiddenproperty(icon, "Image", 'rbxassetid://9801457539')
                    tween(icon, {
                        Rotation = 0,
                        ImageColor3 = theme.Primary
                    }, 0.3, 1)
        ...
        do 
            ...
            local buttonSmall = {} do 
                        ...
                        local clickSensor = Instance.new('TextButton') do 
                            ...
                            local button = Instance.new('Frame') do 
                                ...
                                local icon = Instance.new('ImageLabel') do 
                                    ...
                                    sethiddenproperty(icon, "Image", 'rbxassetid://9801455339')
                                    icon.ImageColor3 = Color3RGB(255, 255, 255)
                                    icon.Name = '#icon'
                                    icon.Position = UDim2.fromOffset(0, 0)
                                    icon.Rotation = 360
                ...
                buttonSmall.click = function(self) 
                    ...
                    tween(icon, {ImageColor3 = Color3RGB(255, 255, 255)}, 1, 1)
                    return self
                end
    ...
    do 
        ...
        local picker = {} do 
                    ...
                    local clickRegion = Instance.new('TextButton') do 
                        ...
                        local picker = Instance.new('Frame') do 
                            ...
                            local display = Instance.new('Frame') do 
                                ...
                                display.BackgroundColor3 = Color3RGB(255, 255, 255)
            ...
            picker.color = Color3RGB(255, 255, 255)
            picker.hue = 0
            picker.sat = 0 
            picker.val = 1
                ...
                window:bindToEvent('close', function() 
                    ...
                    if (self.chroma) then
                        ...
                        self.chromaCon = renderService.RenderStepped:Connect(function(dt) 
                            ...
                            self.hue = hue 
                            self.color = Color3HSV(hue, self.sat, self.val)
            ...
            elemClasses.section.addColorPicker = function(self, settings, callback) 
                ...
                local s_title = settings.text or 'nil'
                local s_color = settings.color or Color3RGB(255, 255, 255)
                ...
                local instances = {} do                     
                    ...
                    local titleBar = Instance.new('Frame') do 
                        ...
                        local icon = Instance.new('ImageLabel') do 
                            ...
                            sethiddenproperty(icon, "Image", 'rbxassetid://9865915364')
                            icon.ImageColor3 = theme.Primary
                            icon.ImageTransparency = 0
                            icon.Name = '#icon'
                            icon.Position = UDim2.fromOffset(2, 2)
